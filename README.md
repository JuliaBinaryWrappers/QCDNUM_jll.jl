# `QCDNUM_jll.jl` (v18.0.0+0)

[![deps](https://juliahub.com/docs/QCDNUM_jll/deps.svg)](https://juliahub.com/ui/Packages/QCDNUM_jll/VpzoV?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c69dcf6dcb4a76ac79f955e9b51ec2d277f79270/Q/QCDNUM/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
...
The tarballs for `QCDNUM_jll.jl` have been built from these sources:

* compressed archive: https://www.nikhef.nl/~h24/download/qcdnum180000.tar.gz (SHA256 checksum: `376a2e6d56761c5356b4ff66cf1c47b48e1155efafc53813cc2e6f11747ca98e`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/c69dcf6dcb4a76ac79f955e9b51ec2d277f79270/Q/QCDNUM/bundled)

## Platforms

`QCDNUM_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `QCDNUM_jll.jl`:
